...
alias df='df -kTh'
alias config='env PKG_CONFIG_PATH="$HOME/lib/pkgconfig" CPPFLAGS="-I$HOME/include" LDFLAGS="-L$HOME/lib" ./configure --prefix=$HOME'
alias config-rape='env LD_LIBRARY_PATH="$HOME/lib" PKG_CONFIG_PATH="$HOME/lib/pkgconfig" CPPFLAGS="-I$HOME/include" LDFLAGS="-L$HOME/lib" ./configure --prefix=$HOME'
alias autoconf='env ACLOCAL_FLAGS="-I/home/epp/phrgba/share/aclocal" ./autogen.sh'
...
#source runtest/_runtest
alias hglog='hg log -l 6'
